...
namespace HttpD
{
    public class Encryption
    {
        ...
        {
            for (int i = 0; i < ShiftRowsTable.Length / 2; i++)
            {
                a[i] = ShiftRowsTable[i];
            }
        }
        
        static void SubBytesInv(byte[] a) 
        {
            for (int i = 0; i < ShiftRowsTableInv.Length / 2; i++)
            {
                a[i] = ShiftRowsTableInv[i];
            }
        }
        ...
        {
            if (((m.Length <= 0 || m == null) || (k.Length <= 0 || k == null)))
